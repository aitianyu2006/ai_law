...
def load_data_multilabel(traning_data_path, valid_data_path, test_data_path, vocab_word2index, accusation_label2index,
                         article_label2index,
                         deathpenalty_label2index, lifeimprisonment_label2index, sentence_len, name_scope='cnn',
                         test_mode=False):
    """
    ...
    train = transform_data_to_index(train_lines, vocab_word2index, accusation_label2index, article_label2index,
                                    deathpenalty_label2index, lifeimprisonment_label2index, sentence_len, 'train',
                                    name_scope)
    valid = transform_data_to_index(valid_lines, vocab_word2index, accusation_label2index, article_label2index,
                                    deathpenalty_label2index, lifeimprisonment_label2index, sentence_len, 'valid',
                                    name_scope)
    test = transform_data_to_index(test_lines, vocab_word2index, accusation_label2index, article_label2index,
                                   deathpenalty_label2index, lifeimprisonment_label2index, sentence_len, 'test',
                                   name_scope)
...
def transform_data_to_index(lines, vocab_word2index, accusation_label2index, article_label2index,
    ...
    accusation_freq_dict, article_freq_dict = load_accusation_articles_freq_dict(accusation_label2index,
                                                                                 article_label2index, name_scope)
    ...
    for i, line in enumerate(lines):
        ...
        if data_type == 'train':  # set specially weight and copy some examples when it is training data.
            ...
            if freq_accusation <= num_mini_examples or freq_article <= num_mini_examples:
                ...
                if i % 1000 == 0: print("####################freq_accusation:", freq_accusation, "freq_article:",
                                        freq_article, ";num_copy:", num_copy)
    ...
    data = (X_, Y_accusation_, Y_article_, Y_deathpenalty_, Y_lifeimprisonment_, Y_imprisonment_, weights_accusation_,
            weights_article_)
...
def create_or_load_vocabulary(data_path, predict_path, training_data_path, vocab_size, name_scope='cnn',
                              test_mode=False):
    """
    create vocabulary
    ...
    if os.path.exists(cache_path):
        ...
        accusation_freq_file = codecs.open(cache_vocabulary_label_pik + "/" + 'accusation_freq.txt', mode='a',
                                           encoding='utf-8')
        ...
        article_freq_file = codecs.open(cache_vocabulary_label_pik + "/" + 'article_freq.txt', mode='a',
                                        encoding='utf-8')
...
def load_accusation_articles_freq_dict(accusation_label2index, article_label2index, name_scope):
    ...
    accusation_freq_file = codecs.open(cache_vocabulary_label_pik + "/" + 'accusation_freq.txt', mode='r',
                                       encoding='utf-8')
...
def replace_money_value(string):
    # print("string:")
    # print(string)
    moeny_list = [1, 2, 5, 7, 10, 20, 30, 50, 100, 200, 500, 800, 1000, 2000, 5000, 7000, 10000, 20000, 50000, 80000,
                  100000, 200000, 500000, 1000000, 3000000, 5000000, 1000000000]
    double_patten = r'\d+\.\d+'
